...
urlpatterns = [
    ...
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/add/', login_required(requeriment_views.RequerimentAddFormView.as_view()),
        name='requeriment-add'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/history/', login_required(requeriment_views.RequerimentHistoryView.as_view()),
        name='requeriment-history'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/graph/', login_required(requeriment_views.RequerimentGraphView.as_view()),
        name='requeriment-graph-detail'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<pk>[0-9]+)/graph/', login_required(requeriment_views.RequerimentGraphDetailView.as_view()),
        name='requeriment-graph'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<pk>[0-9]+)/history/', login_required(requeriment_views.RequerimentHistoryView.as_view()),
        name='requeriment-history'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<pk>[0-9]+)/update/', login_required(requeriment_views.RequerimentUpdateFormView.as_view()),
        name='requeriment-update'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<pk>[0-9]+)/delete/', login_required(requeriment_views.RequerimentDeleteView.as_view()),
        name='requeriment-delete'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/artifact/', login_required(artifact_views.ArtifactView.as_view()),
        name='artifact-requeriment'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<pk>[0-9]+)/', login_required(requeriment_views.RequerimentDetailView.as_view()),
