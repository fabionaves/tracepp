...
urlpatterns = [
    ...
    url(r'^userstory/(?P<pk>[0-9]+)/detail/artifact/add-document/', login_required(artifact_views.ArtifactDocumentForm.as_view()),
        name='artifact-add-document'),
    ...
    url(r'^sprint/(?P<sprint_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/(?P<artifact>[0-9]+)/activity/',
        ...
        name='artifact-activity'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/add-document/',
        login_required(artifact_views.ArtifactDocumentForm.as_view()),
        name='artifact-add-document'),
    ...
    url(r'^requeriment/(?P<requeriment_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/(?P<artifact>[0-9]+)/activity/',
        login_required(artifact_views.ArtifactActivityView.as_view()),
        name='artifact-activity'),
    url(r'^requeriment/(?P<requeriment_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/add-document/',
        login_required(artifact_views.ArtifactDocumentForm.as_view()),
        name='artifact-add-document'),
    ...
    url(
        r'^^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/codeview/',
        login_required(artifact_views.ArtifactCodeView.as_view()),
        name='artifact-codeview'),
    url(
        r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/activity/',
        login_required(artifact_views.ArtifactActivityView.as_view()),
        name='artifact-activity'),
    url(r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/userstory/(?P<pk>[0-9]+)/detail/artifact/add-document/',
        login_required(artifact_views.ArtifactDocumentForm.as_view()),
        name='artifact-add-document'),
    ...
    url(
        r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/artifact/codeview/',
        login_required(artifact_views.ArtifactCodeView.as_view()),
        name='artifact-codeview'),
    url(
        r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/artifact/activity/',
        login_required(artifact_views.ArtifactActivityView.as_view()),
        name='artifact-activity'),
    url(
        r'^sprint/(?P<sprint_id>[0-9]+)/requeriment/(?P<requeriment_id>[0-9]+)/artifact/add-document/',
        login_required(artifact_views.ArtifactDocumentForm.as_view()),
        name='artifact-add-document'),
    ...
    url(
        r'^requeriment/(?P<requeriment_id>[0-9]+)/artifact/codeview/',
        login_required(artifact_views.ArtifactCodeView.as_view()),
        name='artifact-codeview'),
    url(
        r'^requeriment/(?P<requeriment_id>[0-9]+)/artifact/activity/',
        login_required(artifact_views.ArtifactActivityView.as_view()),
        name='artifact-activity'),
    url(
        r'^requeriment/(?P<requeriment_id>[0-9]+)/artifact/add-document/',
        login_required(artifact_views.ArtifactDocumentForm.as_view()),
        name='artifact-add-document'),
    ...
    url(r'^artifact/tracecode-confirm/',        login_required(artifact_views.ArtifactCodeConfirm.as_view()), name='artifact-code-confirm'),
    ...
    url(r'^artifact/tracebugtracking-confirm/',        login_required(artifact_views.ArtifactTraceBugTrackingConfirm.as_view()), name='artifact-bugtracking-confirm'),
